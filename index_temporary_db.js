//  This is temporary backend file 
...
/*----------------------------ANOTHER METHOD TO CONNECT MONGODB---------------------------------------- */


// const { MongoClient } = require('mongodb');
// const uri = ""mongodb+srv://username:<password>@cluster0.0r853.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
// const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
// client.connect(err => {
//     const bcollection = client.db("Book-Management-Backend").collection("books").findOne({ISBN: "1234Three"});
...
//         const result = await client.db("Book-Management-Backend").collection("books").findOne({ISBN: "1234Three"});
//         console.log(result);
